...
INSERT INTO `phinxlog` VALUES (20250418070232,'AppSms','2025-04-21 09:00:46','2025-04-21 09:00:46',0),(20250418072358,'AppSmsToken','2025-04-21 09:00:46','2025-04-21 09:00:46',0),(20250418072732,'WaAdminRoles','2025-04-21 09:00:46','2025-04-21 09:00:47',0),(20250418072848,'WaAdmins','2025-04-21 09:00:47','2025-04-21 09:00:47',0),(20250418073859,'WaOptions','2025-04-21 09:00:47','2025-04-21 09:00:47',0),(20250418074402,'WaRoles','2025-04-21 09:00:47','2025-04-21 09:00:47',0),(20250418074707,'WaRules','2025-04-21 09:00:47','2025-04-21 09:00:47',0),(20250418074922,'WaUploads','2025-04-21 09:00:47','2025-04-21 09:00:47',0),(20250418075424,'WaUsers','2025-04-21 09:00:47','2025-04-21 09:00:47',0),(20250429020952,'SshServer','2025-04-29 05:47:14','2025-04-29 05:47:14',0),(20250429034945,'SshRecords','2025-04-29 05:47:14','2025-04-29 05:47:14',0),(20250429040329,'SshToken','2025-04-29 05:47:14','2025-04-29 05:47:14',0);
/*!40000 ALTER TABLE `phinxlog` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ssh_records`
--

DROP TABLE IF EXISTS `ssh_records`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ssh_records` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `server_id` int DEFAULT NULL COMMENT '服务器',
  `token_id` int DEFAULT NULL COMMENT 'Token',
  `action` enum('login','input','output','close') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '行为',
  `content` longtext COLLATE utf8mb4_general_ci COMMENT '详情',
  `ip` text COLLATE utf8mb4_general_ci COMMENT '操作IP',
  `admin_id` int DEFAULT NULL COMMENT '操作人',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='SSH操作录像';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ssh_records`
--

LOCK TABLES `ssh_records` WRITE;
/*!40000 ALTER TABLE `ssh_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `ssh_records` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ssh_server`
--

DROP TABLE IF EXISTS `ssh_server`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ssh_server` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `host` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '主机地址',
  `port` int DEFAULT '22' COMMENT '端口',
  `auth` enum('none','password','publickey') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '认证方式',
  `username` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '账号',
  `password` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '密码',
  `publickey` text COLLATE utf8mb4_general_ci COMMENT '公钥',
  `privatekey` text COLLATE utf8mb4_general_ci COMMENT '私钥',
  `passphrase` text COLLATE utf8mb4_general_ci COMMENT '证书密码',
  `admin_id` int DEFAULT NULL COMMENT '创建人',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='SSH服务器';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ssh_server`
--

--
-- Table structure for table `ssh_token`
--

DROP TABLE IF EXISTS `ssh_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ssh_token` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `server_id` int DEFAULT NULL COMMENT '服务器',
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=153 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='SSH授权';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wa_admins` VALUES (1,'admin','超级管理员','$2y$12$42YVLih66nbBjkfoP75vxOjU/YqI1KDexWdudwhUrbWZSxw6PEoqu','/app/admin/avatar.png',NULL,NULL,NULL,'2025-04-29 13:45:32','2025-04-21 17:00:47','2025-04-29 13:45:34');
...
CREATE TABLE `wa_options` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='选项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wa_roles` VALUES (1,'超级管理员','*',NULL,'2025-04-21 17:00:47','2025-04-21 17:00:47');
...
CREATE TABLE `wa_rules` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='权限规则';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-19 10:24:13
